...
import Message from "../_more_components/Message";
import SendMessage from "../_more_components/SendMessage";
...
const Messages = (props) => {
  ...
  return props.conservant ? (
      ...
      {messages && conversation && !loading ? (
        <>
          ...
          >
            ...
            <UserImage
              image={props.conservant.picturePath}
              size={30}
            />
            <Typography>
    ...
    >
      ...
      <Typography variant="h5">Mensajería</Typography>
      <Typography color="text.secondary">
        Envía mensajes privados a otros usuarios
      </Typography>
    </Stack>
  );
};
